...
class TicketRechargeTapScreen extends StatefulWidget {
  const TicketRechargeTapScreen({super.key});

  @override
  State<TicketRechargeTapScreen> createState() => _TicketRechargeTapScreenState();
}

class _TicketRechargeTapScreenState extends State<TicketRechargeTapScreen> {
  final TicketRechargeController ticketRechargeController = Get.put(TicketRechargeController());
          ...
          children: [
                      ...
                      flex: 4,
                        child:Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                            //  tcn("Search Customer", Colors.grey, 16,TextAlign.center),
            ...
            Row(
              ...
              children: [
                ...
                gapWC(20),
                IconButtons("Refund", "assets/images/ticketPos/refund.png", () {
                ...
                gapWC(20),
                IconButtons("History", "assets/images/ticketPos/refresh.png", () {
