...
class RechargeScreen extends StatefulWidget {
  ...
  RechargeScreen({Key? key, required this.cardserailnumb,}) : super(key: key);
...
class _RechargeScreenState extends State<RechargeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        title: tsw(AppStrings.topup,AppColors.white,20,FontWeight.w500),
        leading: IconButton(
              ...
              children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                  ts("Card Validity: ", AppColors.fontcolor, 12),
                                  ts(mfnDate(rechargeController.cardValidity.toString(),6), AppColors.fontcolor, 13),
                              ],
                            ),
                            gapHC(2),
                            Row(
                            ...
                            tsw("Top-up card",AppColors.fontcolor,15,FontWeight.w700),
                            gapHC(18),
                            // Material(
                            //   elevation: 30.0,
                            ...
                            //   ),
                            // ),
                            CommonTextfield(controller: rechargeController.txtAmount,textFormFieldType: TextFormFieldType.amount,shadow: 30.0,opacityamount: 0.4,hintText: 'Enter the amount you want to pay',paymentEnable: true),
                            gapHC(38),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                              children: [
                ...
                Padding(
                  ...
                  child: CommonButton(buttoncolor: AppColors.primarycolor, icon_need: false,buttonText: "Pay", onpressed: (){
                    rechargeController.cardnumber.value.isNotEmpty?    rechargeController.fnPay(context,mfnDbl(rechargeController.txtAmount.text) , rechargeController.cardnumber.value, rechargeController.initial_payment_mode.value,"",rechargeController.customer_name.value) :null;
                  }, ),
                ),
                gapHC(10)
              ],
